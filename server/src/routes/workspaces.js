...
router.post(
  '/get',
  validateBody([{ key: 'userId', type: 'number', required: true }]),
  async (req, res) => {
    try {
...
router.post(
  '/get-workflow',
  validateBody([{ key: 'workspaceId', type: 'number', required: true }]),
  async (req, res) => {
    try {
...
router.post(
  '/get-team-workflow',
  validateBody([{ key: 'teamId', type: 'number', required: true }]),
  async (req, res) => {
    try {
