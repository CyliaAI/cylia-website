...
const Login = () => {
  ...
  const handleLogin = () => {
    if (!showSignUp) {
      ...
      axios
        .post(`${import.meta.env.VITE_BACKEND_URL}/api/vendors`, {
          email,
          user: username,
          password,
          type: 'signup',
    ...
    <Layout showFooter={false} showNavbar={false}>
      <div className="w-screen h-screen flex items-center justify-center bg-black">
        <div className="w-[60vw] absolute z-[1] h-[80vh] bg-white/5 rounded-lg pointer-events-none overflow-hidden shadow-lg border border-white/60 flex">
          ...
          <div
            ref={loginRef}
            className="w-1/2 top-[17vh] absolute p-10 text-white flex flex-col justify-center"
          >
            ...
            <div className="mb-6 flex items-center border-b pointer-events-auto border-gray-400">
              ...
              {!showPassword ? (
                <Eye
                  ...
                  className="mr-3 text-gray-400 w-5 h-5 cursor-pointer"
                />
              ) : (
                <EyeOff
            ...
            <p className="mt-4 text-sm">
              ...
              <span
                ...
                className="text-green-400 pointer-events-auto cursor-pointer hover:underline"
              >
                Sign Up
              </span>
            </p>

            <p className="text-gray-400 text-center font-semibold py-4">Or</p>

            <div className="flex">
              <button
                className="bg-gray-100 flex items-center text-black px-4 py-2 rounded-full border-gray-400 border-4 w-full justify-center gap-2 cursor-pointer hover:bg-gray-300 pointer-events-auto transition-all duration-300"
                onClick={OauthLogin}
              >
