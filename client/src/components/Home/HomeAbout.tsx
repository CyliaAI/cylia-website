...
const HomeAbout = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        'Connect your agents with documents, databases, and APIs for enriched intelligence.',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="font-semibold text-white">create intelligent AI agents</span> through a
            fully visual interface, customizable workflows, and automation-ready solutions. Bring
            your ideas to life without writing a single line of code.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-emerald-600 to-teal-600 rounded-3xl p-12 shadow-2xl">
          <h3 className="text-3xl font-bold text-white mb-4">Ready to Build Your AI Agent?</h3>
          <p className="text-emerald-50 text-lg mb-8 max-w-2xl mx-auto">
            Start creating powerful AI agents that can handle any workflow, automate tasks, and
